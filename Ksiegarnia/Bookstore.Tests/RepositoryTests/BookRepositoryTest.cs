...
namespace Bookstore.Tests.RepositoryTests
{
    public  class BookRepositoryTest
    {
        ...
        [Fact]
        public async Task BookRepository_Should_Get_Books_By_Publisher()
        {
            //given
            var dbOptions = new DbContextOptionsBuilder<BookStoreContext>()
            .UseInMemoryDatabase(Guid.NewGuid().ToString())
            ...
            //when
            List<Book> books = bookRepository.GetBooksByPublisher(1, "MG").ToList();
        ...
        [Fact]
        public async Task BookRepository_Should_Get_Books_By_Author()
        {
            //given
            var dbOptions = new DbContextOptionsBuilder<BookStoreContext>()
            .UseInMemoryDatabase(Guid.NewGuid().ToString())
            ...
            //when
            List<Book> books = bookRepository.GetBooksByAuthor(1,"Adam", "Mickiewicz").ToList();
